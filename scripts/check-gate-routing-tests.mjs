...
test("the live repository pins one shared contract-gate list", async () => {
  ...
  assert.ok(
    !bashBlocks.some((block) =>
      block.contents.split(/\r?\n/u).includes("./scripts/findings.py check"),
    ),
  );
});
