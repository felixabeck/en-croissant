...
The measured baseline and enforced ceilings live in `bundle-budgets.json`. The 2026-09-20 production build measured 514,298 B Entry, 508,291 B largest lazy route (`src/routes/index.lazy.tsx`), and 1,546,205 B total (all gzip). Its ceilings are 550,000 B, 550,000 B, and 1,550,000 B respectively. Increasing a limit requires a conscious update of both measurement and rationale in review.
